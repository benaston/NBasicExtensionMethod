...
namespace NBasicExtensionMethod.Test.Fast
{
    ...
    public class IntegerExtensionsTests
    {
        ...
        public void Millisecond_Should_Throw_ArgumentOutOfRangeException_When_Value_Less_Than_One()
        {
            // Arrange
            int iValue = 0;
        ...
        [Test]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void Millisecond_Should_Throw_ArgumentOutOfRangeException_When_Value_Grater_Than_One()
        {
            // Arrange
            int iValue = 2;
        ...
        [Test]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void Second_Should_Throw_ArgumentOutOfRangeException_When_Value_Grater_Than_One()
        {
            // Arrange
            int iValue = 2;
        ...
        [Test]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void Minute_Should_Throw_ArgumentOutOfRangeException_When_Value_Grater_Than_One()
        {
            // Arrange
            int iValue = 2;
        ...
        [Test]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void Hour_Should_Throw_ArgumentOutOfRangeException_When_Value_Grater_Than_One()
        {
            // Arrange
            int iValue = 2;
        ...
        [Test]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void Day_Should_Throw_ArgumentOutOfRangeException_When_Value_Grater_Than_One()
        {
            // Arrange
            int iValue = 2;
        ...
        [TestCase(-1, 1, 3)]
        [TestCase(4, 1, 3)]
        public void IsBetweenInclusive_Should_Return_False_When_Value_Is_Less_Or_Grater_Than_Lower_Or_Upper_Boundary(int iInputValue, int iLowerBoundary, int iUpperBoundary)
        {
            // Arrange
